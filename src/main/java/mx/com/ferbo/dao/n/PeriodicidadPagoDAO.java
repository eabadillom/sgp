...
public class PeriodicidadPagoDAO extends BaseDAO<CatPeriodicidadPago, String> {
    ...
    public PeriodicidadPagoDAO()
    {
        super(CatPeriodicidadPago.class);
    }
    ...
    public List<CatPeriodicidadPago> buscarTodosActivos(Date vigenciaFin) {
        List<CatPeriodicidadPago> modelList = null;
        EntityManager em = null;
    ...
    public List<CatPeriodicidadPago> buscarActivos(Date fecha) {
        List<CatPeriodicidadPago> modelList = null;
        EntityManager em = null;

        try {
            em = this.getEntityManager();
            modelList = em.createNamedQuery("CatPeriodicidadPago.buscarActivo", modelClass)
