...
public class MunicipioDAO extends BaseDAO {
    ...
    public synchronized List<CatMunicipio> obtenerTodosPorEstado(Integer idPais, Integer idEstado) throws SGPException {
        EntityManager em = null;
        List<CatMunicipio> municipios = null;
        try {
            log.info("Inicia proceso de obtener todos los municipios.");
            em = super.getEntityManager();
            TypedQuery<CatMunicipio> resultado = em.createQuery("select e from  CatMunicipio e where e.key.estado.key.pais.id = :idPais and e.key.estado.key.id = :idEstado ", CatMunicipio.class);
            ...
            super.rollback(em);
            log.error("Hubo algun problema al obtener todos los registros de la tabla CatMunicipio. " + ex);
    ...
    public synchronized void guardar(CatMunicipio municipio) throws SGPException {
        ...
        try {
            ...
            em.getTransaction().commit();
            log.info("Finaliza proceso de guardar el registro en la tabla CatMunicipio");
        } catch (Exception ex) {
            super.rollback(em);
            log.error("Hubo algun proble al guardar el registro en la tabla CatMunicipio. " + ex);
    ...
    public synchronized void actualizar(CatMunicipio municipio) throws SGPException {
        ...
        try {
            ...
            em.merge(municipio);
            em.getTransaction().commit();
            log.info("Finaliza proceso de actualizar el registro de la tabla CatMunicipio");
        } catch (Exception ex) {
            super.rollback(em);
            log.error("Hubo algun problema al actualizar el registro en la tabla CatMunicipio. " + ex);
    ...
    public synchronized void eliminar(CatMunicipio municipio) throws SGPException {
        ...
        try {
            ...
            em.getTransaction().commit();
            log.info("Finaliza proceso de eliminar el registro de la tabla CatMunicipio");
        } catch (Exception ex) {
            super.rollback(em);
            log.error("Hubo algun problema al eliminar el registro de la tabla CatMunicipio. " + ex);
