...
@NamedQueries({
    @NamedQuery(name = "CatRegimenFiscal.findByst_per_fisica", query = "SELECT r FROM CatRegimenFiscal r WHERE r.personaFisica = true ORDER BY r.nombre"),
    @NamedQuery(name = "CatRegimenFiscal.findByst_per_moral", query = "SELECT r FROM CatRegimenFiscal r WHERE r.personaMoral = true ORDER BY r.nombre"),
