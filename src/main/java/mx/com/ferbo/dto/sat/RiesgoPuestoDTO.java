...
public class RiesgoPuestoDTO implements Serializable{
    ...
    public String toString() {
        return "RiesgoPuestoDTO [clave=" + clave + ", descripcion=" + descripcion + ", vigenciaInicio=" + vigenciaInicio
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RiesgoPuestoDTO other = (RiesgoPuestoDTO) obj;
        if (clave == null) {
            if (other.clave != null)
                return false;
