...
public class TipoOtroPagoDTO implements Serializable{
    ...
    public String toString() {
        return "TipoOtroPagoDTO [clave=" + clave + ", descripcion=" + descripcion + ", vigenciaInicio=" + vigenciaInicio
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TipoOtroPagoDTO other = (TipoOtroPagoDTO) obj;
        if (clave == null) {
            if (other.clave != null)
                return false;
