...
public class TipoPercepcionDTO implements Serializable {
    ...
    public String toString() {
        return "TipoPercepcionDTO [clave=" + clave + ", descripcion=" + descripcion + ", vigenciaInicio="
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TipoPercepcionDTO other = (TipoPercepcionDTO) obj;
        if (clave == null) {
            if (other.clave != null)
                return false;
