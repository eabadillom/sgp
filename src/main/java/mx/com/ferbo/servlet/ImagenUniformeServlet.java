...
public class ImagenUniformeServlet extends HttpServlet {

	private static final long serialVersionUID = -3585633435637892855L;
	
	private static Logger log = LogManager.getLogger(ImagenUniformeServlet.class);
	
	public ImagenUniformeServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			imagePath = application.getRealPath("resources/recursos/images/prendas/" + imageName);
			...
			imagePath = imageDirectory + File.separator + "uniformes" + File.separator + imageName;
