...
public class PeriodicidadPagoBean implements Serializable {
    ...
    private List<CatPeriodicidadPago> periodicidades;
    private CatPeriodicidadPago periodo;
    ...
    public void cargaLista() {
        this.periodicidades = periodicidadDAO.buscarActivos(fechaActual);
    }

    public void nuevo() {
        log.info("Agregando nueva periodicidad de pago...");
        this.periodo = new CatPeriodicidadPago();
        this.accion = "N";
    }
    ...
    public List<CatPeriodicidadPago> getPeriodicidades() {
        return periodicidades;
    }

    public void setPeriodicidades(List<CatPeriodicidadPago> periodicidades) {
        this.periodicidades = periodicidades;
    }

    public CatPeriodicidadPago getPeriodo() {
        return periodo;
    }

    public void setPeriodo(CatPeriodicidadPago periodo) {
