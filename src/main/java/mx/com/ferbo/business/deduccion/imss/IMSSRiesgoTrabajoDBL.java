 ...
 */
public class IMSSRiesgoTrabajoDBL extends AbstractIMSSDBL implements IDeduccion {
	
	private static Logger log = LogManager.getLogger(IMSSRiesgoTrabajoDBL.class);
	...
	public IMSSRiesgoTrabajoDBL(ParametrosNomina parametros, BigDecimal diasTrabajados, BigDecimal ausencias, BigDecimal incapacidades, BigDecimal sdi) {
