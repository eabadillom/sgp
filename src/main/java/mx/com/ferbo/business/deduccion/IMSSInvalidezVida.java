...
public class IMSSInvalidezVida extends AbstractDeduccion implements IDeduccion {
	...
	public DetNominaDeduccion calcular(DetNomina nomina, Integer index) {
		...
		try {
			...
			tarifaIMSS = tarifaIMSSDAO.buscarPor("O", "IV", this.fechaInicioAnio, this.fechaFinAnio, this.sdi);
			cuota = this.sdi
